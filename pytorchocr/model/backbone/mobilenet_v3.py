...
from pytorchocr.model.common import Activation
...
class SEModule(nn.Module):
    def __init__(self, in_channels, reduction=4, name=""):
        ...
        self.conv2 = nn.Conv2d(
            ...
            padding=0,
            bias=True)
        self.hard_sigmoid = Activation(act_type='hardsigmoid', inplace=True)
        ...
        **kwargs,
        ...
        if model_name == "large":
            ...
            raise NotImplementedError(
                "{} is not implemented.".format(model_name)
            )
        ...
        self.conv1 = ConvBNLayer(
            ...
            groups = 1,
            if_act = True,
            act = "hardswish" # TODO: change it into ReLU6
        )
